                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="payment?doge=500" class="btn btn-success mt-3">Invest</a>
                            </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $3000</p>
                                    <a href="payment?doge=1000" class="btn btn-success mt-3">Invest</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $6000</p>
                                    <a href="payment?doge=2000" class="btn btn-success mt-3">Invest</a>
                                  </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $15000</p>
                                    <a href="payment?doge=5000" class="btn btn-success mt-3">Invest</a>
                                  </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="payment?doge=10000" class="btn btn-success mt-3">Invest</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="payment?doge=20000" class="btn btn-success mt-3">Invest</a>
                            </div>
                            </div>
                        </div>
