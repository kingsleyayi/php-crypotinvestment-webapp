...
<?php require('header.php'); ?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i>Repaid Loan</h2>
    ...
    <tbody>
    <?php while($repaiddetails=mysqli_fetch_assoc($checkpaid)){
        $amount = $repaiddetails['amount'];
        $status = $repaiddetails['status'];
        $accountnumber= $repaiddetails['accountnumber'];
        $name = $repaiddetails['name'];
        $repay = $repaiddetails['repaydate'];
        $salary = $repaiddetails['salary'];
        $dob = $repaiddetails['dob'];
        $employer = $repaiddetails['employer'];
        $salary = $repaiddetails['salary'];
        $address = $repaiddetails['address'];
        $reason = $repaiddetails['reason'];
        $phone = $repaiddetails['phone'];
        $email = $repaiddetails['email'];
        $gender =$repaiddetails['gender'];
        $image = $repaiddetails['images'];
        $id = $repaiddetails['id'];
        $specicial = $repaiddetails['specialid'];
        ?>
    <tr>
        <td><?php echo $repaiddetails['name'];?></td>
        <td class="center">
            <span class="label-success label label-default"><?php echo $repaiddetails['status'];?></span>
        </td>
        <td class="center">
