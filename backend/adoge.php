              ...
              <div class="card settings_menu">
                  ...
                  <div class="card-body">
                      <ul>
                          ...
                          <li class="nav-item">
                              <a href="doge.php" class="nav-link active">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-xl-4">
                                    ...
                                    <img src="images/doge.png" alt="" class="img-fluid">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="apayment?doge=500" class="btn btn-success mt-3">Invest</a>
                            </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $3000</p>
                                    <a href="apayment?doge=1000" class="btn btn-success mt-3">Invest</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $6000</p>
                                    <a href="apayment?doge=2000" class="btn btn-success mt-3">Invest</a>
                                  </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $15000</p>
                                    <a href="apayment?doge=5000" class="btn btn-success mt-3">Invest</a>
                                  </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="apayment?doge=10000" class="btn btn-success mt-3">Invest</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="apayment?doge=20000" class="btn btn-success mt-3">Invest</a>
                            </div>
                            </div>
                        </div>
