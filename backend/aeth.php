          ...
          <div class="col-xl-3 col-md-4">
              <div class="card settings_menu">
                  ...
                  <div class="card-body">
                      <ul>
                          <li class="nav-item">
                              <a href="abtc.php" class="nav-link">
                                  <i class="cc BTC-alt"></i>
                                  <span>Bitcoin investment</span>
                              </a>
                          </li>
                          <li class="nav-item">
                              <a href="aeth.php" class="nav-link active">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-xl-4">
                                    ...
                                    <img src="images/eth2.png" alt="" class="img-fluid">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="apayment?eth=500" class="btn btn-success mt-3">Invest</a>
                            </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $3000</p>
                                    <a href="apayment?eth=1000" class="btn btn-success mt-3">Invest</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $6000</p>
                                    <a href="apayment?eth=2000" class="btn btn-success mt-3">Invest</a>
                                  </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $15000</p>
                                    <a href="apayment?eth=5000" class="btn btn-success mt-3">Invest</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="apayment?eth=10000" class="btn btn-success mt-3">Invest</a>
                              </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  <div class="id_info">
                                      ...
                                      <a href="apayment?eth=20000" class="btn btn-success mt-3">Invest</a>
                                    </div>
                            </div>
                        </div>
