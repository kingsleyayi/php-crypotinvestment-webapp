              ...
              <div class="card settings_menu">
                  ...
                  <div class="card-body">
                      <ul>
                          ...
                          <li class="nav-item">
                              <a href="eth.php" class="nav-link active">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="payment?eth=500" class="btn btn-success mt-3">Invest</a>
                            </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $3000</p>
                                    <a href="payment?eth=1000" class="btn btn-success mt-3">Invest</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $6000</p>
                                    <a href="payment?eth=2000" class="btn btn-success mt-3">Invest</a>
                                  </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <p class="mb-1"> <span class="font-weight-bold">Total return: </span> $15000</p>
                                    <a href="payment?eth=5000" class="btn btn-success mt-3">Invest</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  ...
                                  <a href="payment?eth=10000" class="btn btn-success mt-3">Invest</a>
                              </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="id_info">
                                  <div class="id_info">
                                      ...
                                      <a href="payment?eth=20000" class="btn btn-success mt-3">Invest</a>
                                    </div>
                            </div>
                        </div>
